...
Registers the specified _listener_ to receive events of the specified _type_
...
word objects that were successfully placed, and a _bounds_ object of the form
...
source url: https://github.com/cesine/d3-cloud
# d3-cloud
# d3-cloud
